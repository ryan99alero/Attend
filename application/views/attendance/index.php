                    ...
                    <div class="card shadow mb-4" style="min-height: 543px">
                        ...
                        <div class="card-body">
                            ...
                            <?php if ($in == false) : ?>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-5">
                                        ...
                                        <input class="form-control" type="text" placeholder="<?= $account['shift']; ?>"
                                               value="<?= $account['shift']; ?>" name="work_shift" readonly>
                                    </div>
                                    <div class="col-lg-5 offset-lg-1">
                                        <label for="location" class="col-form-label">Check In Location</label>
                                        <select class="form-control" name="location" id="location">
                                            <?php foreach ($location as $lct) : ?>
                                                <option value="<?= $lct['id'] ?>"><?= $lct['id']; ?>
                                                    = <?= $lct['name'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                            ...
                            <h6 class="card-title text-center mb-4 px-4">The world of business survives less on
                                leadership skills and more on the commitment and dedication of passionate employees like
