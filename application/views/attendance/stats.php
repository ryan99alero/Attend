            ...
            <div class="card-body">
                <div class="table-responsive table-bordered">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        foreach ($data['attendance'] as $atd) :
                            ...
                            <tr <?php if (date('l', $atd['date']) == 'Saturday' || date('l', $atd['date']) == 'Sunday') {
                                ...
                                // if WEEKDAYS
                                    ...
                                    <!-- Column 6 (Image) -->
                                    <td><?php if ($atd['image']) : ?>
                                            <img src="<?= base_url('images/attendance/') . $atd['image']; ?>"
                                                 style="height: 70px">
                                        <?php else : ?>
                                            Image Not Found
                                        <?php endif; ?>
                        ...
                        <?php endforeach; ?>
                        <a href="<?= base_url('print_atd/print/') . $e_id . '/' . $data['start'] . '/' . $data['end']; ?>"
                           target="blank"
                           class="ml-2 d-none d-sm-inline-block btn btn-sm btn-info shadow-sm float-right"><i
